/*
  ...
  - You are about to drop the column `contenuto1` on the `Commento` table. All the data in the column will be lost.
  - Added the required column `contenuto` to the `Commento` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "Utente" (
    ...
    "permessi" TEXT NOT NULL DEFAULT 'GUEST'
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Utente_nickname_key" ON "Utente"("nickname");
